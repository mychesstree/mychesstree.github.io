...
export default function PuzzleInterface({ game, positionIndex, onClose, onNext, selectedDate = new Date(), onDateChange, dateRange }: PuzzleInterfaceProps) {
  const { user } = useAuth();
  ...
  const handleDateChange = (direction: 'prev' | 'next') => {
    if (!onDateChange || !dateRangeState) return;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ 
          ...
          <div className="chess-board-container" style={{ display: 'flex', width: '100%' }}>
            {/* Eval Bar Container */}
            <div
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                ...
                <button
                  ...
                  disabled={!dateRangeState || selectedDate >= dateRangeState.latest}
                >
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                ...
                <span style={{ fontSize: '0.85rem', fontWeight: '600' }}>
                  {completedPositions.size}/{game.puzzle_positions.length}
                </span>
              </div>
